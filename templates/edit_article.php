<?php $this->title = 'Modification-Biblio'; ?>
<br />
<h1 class="text-center">Modification de : <i><?= isset($post) ?($post->get('titre')): ''; ?></i></h1>
<br />
 <div class="container">
    <div class="row">
		<section class="col-12">
		    <form method="post" action="../public/index.php?route=editArticle&articleId=<?= htmlspecialchars($post->get('id')); ?>"  class="mb-5">
                ...
                <div class="form-group col-md-6">						
					...
					<select id="categorie" name="categorie" class="form-control">
						<option value="<?= isset($post) ? ($post->get('categorie')): ''; ?>"><?= isset($post) ? ($post->get('categorie')): ''; ?></option>
				...
				<div class="form-group col-md-6">						
					...
					<select id="type" name="type" class="form-control">
						<option value="<?= isset($post) ? ($post->get('type')): ''; ?>"><?= isset($post) ? ($post->get('type')): ''; ?></option>
